...
function createUserCard(userData) {
    ...
    card.classList.add('flex', 'items-center', 'gap-2', 'p-4', 'transition-shadow', 'duration-300', 'ease-in-out', 'bg-white', 'rounded-lg', 'shadow-lg', 'hover:shadow-xl', 'md:gap-3', 'relative', 'overflow-hidden');
    card.innerHTML = `
